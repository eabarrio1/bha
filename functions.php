...
register_nav_menus( array(
	'mobile-nav' => __( 'Mobile Navigation', 'twentyten' ),
) );
...
register_new_royalslider_files(2); 
	...
	register_sidebar(array('name'=>'Page Sidebar',
		...
		// Boxes
	// Location: the sidebar
	register_sidebar(array('name'=>'Boxes',
		'before_widget' => '<div id="box">',
		'after_widget' => '</div>',
		'before_title' => '<h2>',
		'after_title' => '</h2>',
	));
			...
			// Left Box
	register_sidebar(array('name'=>'Home Left Box',
		'before_widget' => '<div id="box">',
		'after_widget' => '</div>',
		'before_title' => '<h2 class="beacon">',
		'after_title' => '</h2>',
	));
	
		// Middle Box
	register_sidebar(array('name'=>'Home Middle Box',
		'before_widget' => '<div id="box">',
		'after_widget' => '</div>',
		'before_title' => '<h2 class="partner">',
		'after_title' => '</h2>',
	));
	
		// Right Box
	register_sidebar(array('name'=>'Home Right Box',
		'before_widget' => '<div id="box">',
		'after_widget' => '</div>',
		'before_title' => '<h2 class="liability">',
		'after_title' => '</h2>',
	));
